...
class TestTaobao:
    ...
    def test_search_products(self, runner, config):
...
class TestJD:
    ...
    def test_extract_specs(self, runner, config):
...
class TestPDD:
    ...
    def test_extract_group_price(self, runner, config):
