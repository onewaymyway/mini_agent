...
class TestEcommerceFlow(BaseBrowserTest):
    ...
    def test_01_navigate_to_store(self):
        ...
        with patch.object(browser_nav, "goto") as mock_goto:
            ...
            result = browser_nav.cmd_goto("https://example-store.com/home")
    ...
    def test_02_search_product(self):
        ...
        with patch.object(browser_input, "type_selector") as mock_type, \
            ...
            # 执行搜索操作
            browser_input.type_text("input[name=query]", "wireless headphones")
            browser_input.mouse_click("button[type=submit]")
    ...
    def test_03_view_product_details(self):
        ...
        with patch.object(browser_input, "click_selector") as mock_click:
            mock_click.return_value = None
            browser_input.mouse_click(".product-list a")
    ...
    def test_05_view_cart(self):
        ...
        with patch.object(browser_nav, "goto") as mock_goto:
            mock_goto.return_value = True
            browser_nav.cmd_goto("https://example-store.com/cart")
            ...
            with patch.object(browser_extract, "extract_elements") as mock_extract:
                ...
                items = browser_extract.mode_html(mode="elements")
    ...
    def test_06_checkout_simulation(self):
        ...
        with patch.object(browser_input, "type_selector") as mock_type, \
            ...
            # 填写表单字段
            browser_input.type_text("#shipping-name", "John Doe")
            browser_input.type_text("#shipping-address", "123 Main St")
            browser_input.type_text("#shipping-email", "john@example.com")
            
            # 选择支付方式
            browser_input.mouse_click(".payment-method.credit-card")
            
            # 提交订单（模拟）
            browser_input.mouse_click("#checkout-button")
    ...
    def test_08_extract_product_reviews(self):
        ...
        with patch.object(browser_extract, "extract_elements") as mock_extract:
            ...
            reviews = browser_extract.mode_html(mode="elements", selector=".review")
