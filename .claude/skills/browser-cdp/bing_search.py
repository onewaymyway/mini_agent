...
# ========== Cookie 管理功能 ==========
COOKIE_FILE = SKILL_DIR / "temp_data" / "bing_cookies.json"
...
def ensure_browser(port: int = 9333, name: str = "bing_search", headless: bool = False, start_url: str = "https://www.bing.com", user_agent: str = None) -> Dict:
    ...
    if not tab_id:
        ...
        new_tab_result = run_cmd([PYTHON_CMD, "browser_launch.py", "--new", "https://www.bing.com", "--port", str(port)])
    ...
    # 加载并应用保存的 cookies
    load_cookies()
    apply_cookies_to_tab(port, tab_id, "bing.com")
