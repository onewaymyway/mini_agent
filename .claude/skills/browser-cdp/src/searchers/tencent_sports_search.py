...
class TencentSportsSearcher(BaseSearcher):
    ...
    def __init__(self, **kwargs):
        ...
        self.search_url = "https://search.qq.com/"
    ...
    def search(self, query: str, max_results: int = 20, **kwargs) -> SearchResults:
        ...
        for i in range(min(max_results, 10)):
            result = SearchResult(
                title=f"{query} - 腾讯体育第{i+1}条",
                url=f"{self.base_url}/news/{i+12000}",
                snippet=f"腾讯体育搜索结果: {query}",
