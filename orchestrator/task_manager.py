...
from orchestrator.task import Task, TaskRecord, TaskStatus
from orchestrator.sub_agent import SubAgent, LogCallback
...
class TaskManager:
    ...
    def max_workers(self) -> int:
        from orchestrator.concurrency import get_task_sem
        try:
    ...
    def max_workers(self, value: int) -> None:
        from orchestrator.concurrency import set_max_tasks
        try:
            set_max_tasks(value)
        except Exception:
            pass
