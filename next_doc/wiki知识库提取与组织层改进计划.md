...
> **实施状态：§1.2.1/§1.2.2 已完成**，详见 `next_doc/wiki提取层改进计划_E1实施记录.md`
...
> **实施状态：已完成**，详见 `next_doc/wiki提取层改进计划_O2实施记录.md`
...
> **实施状态：已完成**，详见 `next_doc/wiki提取层改进计划_O3实施记录.md`
...
| 第二批 | E1（抽取时机解耦，独立触发器 + cursor 机制） | 3-4 天 | 无强依赖，可与 E3 并行 | **已完成**（`wiki提取层改进计划_E1实施记录.md`） |
