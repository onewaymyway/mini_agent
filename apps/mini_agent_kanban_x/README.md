...
| P2 | Chat 流式对话（SSE 增量渲染）、Sessions 会话管理（列表/详情/新建/恢复/删除） | ✅ |
| P3 | Files 文件浏览、DiffView | ⏳ 规划中，见方案文档第 5 节 |
| P4 | Permissions/Interactions 审批、SelfStatus 只读诊断面板 | ⏳ 规划中 |
| P5 | Users 用户管理、生产部署接入 FastAPI 静态资源挂载 | ⏳ 规划中 |
